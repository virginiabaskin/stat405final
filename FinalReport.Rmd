...
First, we began our exploration by looking at the distribution of citations over time. We first visualized citations issued to each race over the years 2014-2020 in order to evaluate the consistency of the distribution of citations over time.
...
Next in our investigation of citations throughout time, we decided to visualize the number of citations issued throughout the hours of the day.
...
Following this visualization, our team determined that we would like to compare the distribution of citations by race to the demographics of Houston to see if any racial groups receive a disproportionate amount of citations as compared to their representation within the city of Houston. 
...
We then found the top 5 police beats in terms of number of citations:
```{r, echo=FALSE}
kable(csqm_top)
...
Following this, we found the bottom 5 police beats in terms of number of citations: 
```{r, echo=FALSE}
kable(csqm_bottom)
